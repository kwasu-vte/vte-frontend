...
const CreateCourseModal: React.FC<CreateCourseModalProps> = ({ setIsCreateCourseModalOpen }) => {
    ...
    return (
        ...
        >
            <div className=' lg:h-[60%] lg:w-[60%] bg-[#D7ECD7] w-[95%]  min-h-[60%] flex flex-col items-start justify-center px-[10px]'>
                <div className=' w-fit mb-4'>
                    <h1 className=' text-xl text-[#379E37]'>Create New Staff</h1>
